...
const WILL_MAX_ADDRESS = 'MAX##@78.141.238.36:9001';
const WILL_PK = '';
    ...
    getPublicKey(function (pk) {
        getMLS(function (mls) {
            ...
            createSubscriptionsTable(function (result) {
                ...
                createSubscription({
                    permanentAddress: WILL_MAX_ADDRESS,
                    storeName: 'Dbay Store',
                    callback: function (res, error) {
                        if (error) {
                            MDS.log('Error creating subscription: ' + error);
                        } else {
                        MDS.log('Subscribed to Dbay Shop: ' + res);
                        }
                    }
                });
            });
...
function createSubscription(options) {
    var permanentAddress = options.permanentAddress;
    var storeName = options.storeName || '';
    var storeDescription = options.storeDescription || '';
    var storeImage = options.storeImage || '';
